...
public class ManageRecords extends AppCompatActivity {
    ...
    private static String urlHost = "http://192.168.254.103/ancuin/SelectItemDetails.php";
    private static String urlHostDelete="http://192.168.254.103/ancuin/delete.php";
    private static String urlHostGender = "http://192.168.254.103/ancuin/selectGender.php";
    private static String urlHostCivilStatus = "http://192.168.254.103/ancuin/selectCivilStatus.php";
    private static String urlHostID = "http://192.168.254.103/ancuin/selectid.php";
    ...
    private class uploadDataToURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s){
            ...
            pDialog.dismiss();
            String isEmpty = "";
            AlertDialog.Builder alert = new AlertDialog.Builder(ManageRecords.this);
            if (s != null){
